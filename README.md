...
### Part 1A — Leaky Integrate-and-Fire Neuron (`Assessment_Part_1A.m`)
...
### Part 1B — Hodgkin-Huxley Model (`Assessment_Part_1B.m`)
...
### Part 2 — Dendrites and Cable Theory (`Assessment_Part_2.m`)
...
### Part 3 — Networks and Cognition (`Assessment_Part_3.m`)
